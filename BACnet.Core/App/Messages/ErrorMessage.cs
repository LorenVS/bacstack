...
{
    public class ErrorMessage : IAppMessage
    {
        /// <summary>
        /// The message type for error messages
        /// </summary>
        public MessageType Type { get { return MessageType.Error; } }

        /// <summary>
        /// The invoke id of the transaction that
        /// caused the error
        /// </summary>
        public byte InvokeId { get; set; }

        /// <summary>
        /// The service choice of the original
        ...
        public int Serialize(byte[] buffer, int offset)
        {
            ...
            offset = Tags.Encode(buffer, offset, Error);
            return offset;
        }
