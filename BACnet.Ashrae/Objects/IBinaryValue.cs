...
namespace BACnet.Ashrae.Objects
{
    public interface IBinaryValue
    {
        ...
        [PropertyId(PropertyIdentifier.MinimumOffTime)]
        Option<uint> MinimumOffTime { get; }

        [PropertyId(PropertyIdentifier.MinimumOnTime)]
        Option<uint> MinimumOnTime { get; }

        [PropertyId(PropertyIdentifier.PriorityArray)]
        Option<PriorityArray> PriorityArray { get; }

        [PropertyId(PropertyIdentifier.RelinquishDefault)]
        Option<BinaryPV> RelinquishDefault { get; }
