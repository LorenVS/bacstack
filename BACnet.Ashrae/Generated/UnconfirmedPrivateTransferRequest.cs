...
{
	public  partial class UnconfirmedPrivateTransferRequest
	{
		...
		public UnconfirmedPrivateTransferRequest(uint vendorID, uint serviceNumber, Option<GenericValue> serviceParameters)
		{
		...
		public static UnconfirmedPrivateTransferRequest Load(IValueStream stream)
		{
			...
			return new UnconfirmedPrivateTransferRequest(vendorID, serviceNumber, serviceParameters);
		}

		public static void Save(IValueSink sink, UnconfirmedPrivateTransferRequest value)
		{
			sink.EnterSequence();
