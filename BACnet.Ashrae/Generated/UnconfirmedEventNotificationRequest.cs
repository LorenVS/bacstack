...
{
	public  partial class UnconfirmedEventNotificationRequest
	{
		...
		public static UnconfirmedEventNotificationRequest Load(IValueStream stream)
		{
			...
			return new UnconfirmedEventNotificationRequest(processIdentifier, initiatingDeviceIdentifier, eventObjectIdentifier, timeStamp, notificationClass, priority, eventType, messageText, notifyType, ackRequired, fromState, toState, eventValues);
		}
