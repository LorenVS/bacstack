...
{
	public  partial class ConfirmedCOVNotificationRequest
	{
		...
		public ConfirmedCOVNotificationRequest(uint subscriberProcessIdentifier, ObjectId initiatingDeviceIdentifier, ObjectId monitoredObjectIdentifier, uint timeRemaining, ReadOnlyArray<PropertyValue> listOfValues)
		{
		...
		public static ConfirmedCOVNotificationRequest Load(IValueStream stream)
		{
			...
			return new ConfirmedCOVNotificationRequest(subscriberProcessIdentifier, initiatingDeviceIdentifier, monitoredObjectIdentifier, timeRemaining, listOfValues);
		}

		public static void Save(IValueSink sink, ConfirmedCOVNotificationRequest value)
		{
			sink.EnterSequence();
